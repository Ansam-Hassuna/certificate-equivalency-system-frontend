...
export const REQUEST_ROWS = [
  ...
  { id:"EQ-2026-00126", ownerUserId:"mock-user-003", applicant:"مقدم طلب 3", applicantEn:"Applicant 3", qualification:"دكتوراه", qualificationEn:"PhD", qualificationKey:"doctorate", university:"جامعة خارجية", universityEn:"Foreign university", status:"لدى اللجنة", statusEn:"With committee", statusKey:"COMMITTEE", date:"2026-08-18", archived:false },
...
export const ARCHIVED_REQUEST_ROWS = [
  ...
  { id:"EQ-2022-00419", ownerUserId:"mock-user-007", applicant:"محمد حسن", applicantEn:"Mohammad Hassan", qualification:"دكتوراه", qualificationEn:"PhD", qualificationKey:"doctorate", university:"جامعة خارجية", universityEn:"Foreign university", status:"مكتمل", statusEn:"Completed", statusKey:"COMPLETED", date:"2022-05-22", archived:true },
];

export const getAllRequestRows = () => [
  ...REQUEST_ROWS,
  ...ARCHIVED_REQUEST_ROWS,
  ...getStoredApplications(),
];

export const ALL_REQUEST_ROWS = getAllRequestRows();

export const getLocalizedRequestRows = (language = "ar", rows = getAllRequestRows()) =>
  rows.map((row) => ({
    ...row,
