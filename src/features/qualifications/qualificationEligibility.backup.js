...
import { getStoredPreviousQualifications } from "./previousQualificationStore";
...
function isApproved(application) {
  ...
  const verificationStatus =
    String(application?.verificationStatus || "")
      .trim()
      .toLowerCase();
  ...
  return applicantQualifications.filter(
    (qualification) =>
      (
        ...
        qualification?.qualificationType === qualificationLevel
      ) &&
      isApproved(qualification)
  );
}
